...
<h2>Etsi laskuttamattomista varauksista</h2>
Hae asiakkaan nimellä tai varausnumerolla<br />
<input type="text" class="textinput" name="haku" value="" onkeyup="haeLaskuttamattomistaVarauksista(this.value)" />

<hr class="erotin" />

<h2>Listaa toimipisteen laskuttamattomat varaukset</h2>

<select class="dropdownmenu" name="toimipisteid" id="toimipiste" onclick="haeLaskuttamattomatVaraukset()">
